...
class Scope {
    ...
    constructor(
        ...
        this._command = CommandParser.parse(this._message._text, "/")
    ...
    runMenu(menuData) {
        ...
        const selective = (menuData.selective && menuData.selective === true)

        let replyMarkup = new ReplyKeyboardMarkup(keyboard, resizeKeyboard, oneTimeKeyboard, selective)
    ...
    editMessageText(text, options) {
        return this._api.editMessageText(text, options)
    }
